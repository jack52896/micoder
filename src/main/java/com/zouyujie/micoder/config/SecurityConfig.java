...
@Configuration
public class SecurityConfig extends WebSecurityConfigurerAdapter implements MicoderConstant {
    @Override
...
//                            writer.write(MicoderUtil.getJson(403, "你还没有登录哦!"));
//                        } else {
...
//                            response.setContentType("application/plain;charset=utf-8");
//                            PrintWriter writer = response.getWriter();
//                            writer.write(MicoderUtil.getJson(403, "你没有访问此功能的权限!"));
//                        } else {
